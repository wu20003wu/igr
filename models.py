...
class DbMsg(db.Model):
    ...
    in_link_relation = db.relationship('FixdConfig', foreign_keys=[in_link], backref='incoming_messages')
    out_link_relation = db.relationship('FixdConfig', foreign_keys=[out_link], backref='outgoing_messages')
